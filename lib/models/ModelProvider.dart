...
import 'Bag.dart';
import 'BagProduct.dart';
import 'Brand.dart';
import 'BroadCategory.dart';
import 'ContentBased.dart';
import 'FinerCategory.dart';
import 'ModelBased.dart';
import 'Product.dart';
import 'Review.dart';
...
export 'Bag.dart';
export 'BagProduct.dart';
export 'BagStatus.dart';
export 'Brand.dart';
export 'BroadCategory.dart';
export 'ContentBased.dart';
export 'FinerCategory.dart';
export 'Gender.dart';
export 'ModelBased.dart';
export 'Product.dart';
export 'Review.dart';
...
class ModelProvider implements ModelProviderInterface {
  ...
  ModelType getModelTypeByModelName(String modelName) {
    switch(modelName) {
      case "Bag":
        return Bag.classType;
      case "BagProduct":
        return BagProduct.classType;
      case "Brand":
        return Brand.classType;
      case "BroadCategory":
        return BroadCategory.classType;
      case "ContentBased":
        return ContentBased.classType;
      case "FinerCategory":
        return FinerCategory.classType;
      case "ModelBased":
        return ModelBased.classType;
      case "Product":
