...
class Brand extends Model {
  ...
  const Brand._internal({required this.id, title, Products, createdAt, updatedAt}): _title = title, _Products = Products, _createdAt = createdAt, _updatedAt = updatedAt;
  
  factory Brand({String? id, String? title, List<Product>? Products}) {
  ...
  Brand copyWith({String? id, String? title, List<Product>? Products}) {
    return Brand._internal(
      id: id ?? this.id,
  ...
  Map<String, dynamic> toJson() => {
    'id': id, 'title': _title, 'Products': _Products?.map((Product? e) => e?.toJson()).toList(), 'createdAt': _createdAt?.format(), 'updatedAt': _updatedAt?.format()
  };
  
  Map<String, Object?> toMap() => {
    'id': id, 'title': _title, 'Products': _Products, 'createdAt': _createdAt, 'updatedAt': _updatedAt
  };
...
class _BrandModelType extends ModelType<Brand> {
